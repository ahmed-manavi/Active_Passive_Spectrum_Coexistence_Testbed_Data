# -*- coding: utf-8 -*-
"""
Created on Tue Nov 21 21:30:35 2023
...
base_path_hdf = r"Z:/Data Files/SWIFT/HDF_processed_version_1/RFI/inbandNEW"
Base_sc16 = 'Z:/Data Files/SWIFT/Version_6/in_band'
RB_dir = 'Sixteen_RB'
...
inband_directories_all_fc = [d for d in directories_all_fc if d.startswith(RB_dir)]
...
for inband_dir in inband_directories_all_fc:
    ...
    sub_directories = [d for d in os.listdir(dir_path) if os.path.isdir(os.path.join(dir_path, d)) and 'inband' in d]
               ...
               # filename_5G = path_to_files + f"in_band_8RB_10dB_5G_SN{SN_count}.h5"
                ...
                if not os.path.exists(filename_L1B_path): 
                    ...
                    # Create the "L1A" group
                        ...
                        print(f"Ground Truth {TB_G}")
                        print(f"Measured Horizontal {TB_avg_result_h}")
                        print(f"Measured Vertical {TB_avg_result_v}")
                        print(f"Measured Horizontal Spectral {np.mean(TB_spect_result_h)}")
                        print(f"Measured Veritcal Spectral {np.mean(TB_spect_result_v)}")
                ...
                print(f"Sample Number Saving {SN_count}")
                SN_count = 1 + SN_count
